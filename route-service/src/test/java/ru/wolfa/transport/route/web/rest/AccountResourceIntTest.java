...
import ru.wolfa.transport.route.config.Constants;
import ru.wolfa.transport.route.RouteServiceApp;
import ru.wolfa.transport.route.domain.Authority;
import ru.wolfa.transport.route.domain.User;
import ru.wolfa.transport.route.repository.AuthorityRepository;
import ru.wolfa.transport.route.repository.UserRepository;
import ru.wolfa.transport.route.security.AuthoritiesConstants;
import ru.wolfa.transport.route.service.MailService;
import ru.wolfa.transport.route.service.dto.UserDTO;
import ru.wolfa.transport.route.web.rest.errors.ExceptionTranslator;
import ru.wolfa.transport.route.web.rest.vm.KeyAndPasswordVM;
import ru.wolfa.transport.route.web.rest.vm.ManagedUserVM;
import ru.wolfa.transport.route.service.UserService;
