...
describe('Service Tests', () => {
    ...
    describe('RoutePointRouteService Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RoutePointRouteServiceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/route-points';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RoutePointRouteService', () => {
