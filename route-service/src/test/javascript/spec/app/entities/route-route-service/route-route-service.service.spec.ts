...
describe('Service Tests', () => {
    ...
    describe('RouteRouteService Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RouteRouteServiceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/routes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RouteRouteService', () => {
