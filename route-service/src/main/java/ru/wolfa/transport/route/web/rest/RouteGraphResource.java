...
public class RouteGraphResource {
    ...
    @Timed
    public ResponseEntity<RouteGraphDTO> createRouteGraph(@Valid @RequestBody RouteGraphDTO routeGraphDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<RouteGraphDTO> updateRouteGraph(@Valid @RequestBody RouteGraphDTO routeGraphDTO) throws URISyntaxException {
