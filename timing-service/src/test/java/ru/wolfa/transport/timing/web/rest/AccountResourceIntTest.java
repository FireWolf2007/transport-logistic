...
import ru.wolfa.transport.timing.config.Constants;
import ru.wolfa.transport.timing.TimingServiceApp;
import ru.wolfa.transport.timing.domain.Authority;
import ru.wolfa.transport.timing.domain.User;
import ru.wolfa.transport.timing.repository.AuthorityRepository;
import ru.wolfa.transport.timing.repository.UserRepository;
import ru.wolfa.transport.timing.security.AuthoritiesConstants;
import ru.wolfa.transport.timing.service.MailService;
import ru.wolfa.transport.timing.service.dto.UserDTO;
import ru.wolfa.transport.timing.web.rest.errors.ExceptionTranslator;
import ru.wolfa.transport.timing.web.rest.vm.KeyAndPasswordVM;
import ru.wolfa.transport.timing.web.rest.vm.ManagedUserVM;
import ru.wolfa.transport.timing.service.UserService;
