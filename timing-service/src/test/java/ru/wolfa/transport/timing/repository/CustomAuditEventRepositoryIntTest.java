...
import ru.wolfa.transport.timing.config.audit.AuditEventConverter;
import ru.wolfa.transport.timing.domain.PersistentAuditEvent;
...
import static ru.wolfa.transport.timing.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
