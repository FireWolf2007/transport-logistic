...
describe('Service Tests', () => {
    ...
    describe('RouteGraphTimingService Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RouteGraphTimingServiceService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/route-graphs';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return RouteGraphTimingService', () => {
