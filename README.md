...
Тут на помощь может прийти сохранение некторой статистической информации, например,  количество точек в машруте, чтобы отсечь явно не удовлетворяющие маршруты.
